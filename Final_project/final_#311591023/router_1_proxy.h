#ifndef _HPG_router_1_proxy_h_H_
#define _HPG_router_1_proxy_h_H_

#include "systemc.h"

SC_HDL_MODULE( router_1) {
    sc_in<bool> clk;
    sc_in<bool> rst;
    ...
    router_1(sc_module_name name, const char* hdlSrcPath="") : 
        sc_hdl_module(name), hpg_log_lib("CWR_HDL_WORK"), hpg_module_name("router_1"), hpg_hdl_src_path()
